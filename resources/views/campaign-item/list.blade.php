                    ...
                    <div class="table-responsive" style="overflow: visible !important;">
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light text-muted small text-uppercase">
                                <tr>
                                    <th class="ps-4">#ID - Item / Campanha</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <div class="fw-bold text-dark">#{{ $campaignItem->id }} - {{ $campaignItem->name }}</div>
                                    ...
                                    <td class="text-center pe-4">
                                        <div class="btn-group shadow-sm">
                                            ...
                                            <a class="btn btn-sm btn-light border-start" href="{{ route('whatsapp-jobs.index',$campaignItem->id) }}" title="Logs"><i class="bi bi-journal-text"></i></a>
